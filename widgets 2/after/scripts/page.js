...
$(function () {
    ...
    $("#accordian").accordion("activate", false); //<--activate an element of the accordion or you can deactivate them so that they are all collapsed
    ...
    $("#search").autocomplete({ //<--suggested values defined in the var classes
